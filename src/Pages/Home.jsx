...
const WORDS = ["Rekayasa Perangkat Lunak Student @SMK", "Code & Tech Enthusiast"];
const TECH_STACK = ["Mysql", "C++", "Node.js", "PawnCode"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/hfiz4rr" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/achmad-hafidzar/" },
  { icon: Instagram, link: "https://www.instagram.com/hffzrr?igsh=ZDZiZ3JxZm1pdnQ1" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Merancang API, Database, dan Infrastruktur Server yang Kuat untuk Mendukung Aplikasi Digital.
                </p>
